...
class ImageFolder(data.Dataset):
    ...
    def __init__(self,root_path, datasets='Messidor',  mode='train'):
        ...
        assert self.dataset in ['RIM-ONE', 'Messidor', 'ORIGA', 'DRIVE', 'Cell', 'Vessel','CHASEDB'], \
            "the dataset should be in 'Messidor', 'ORIGA', 'RIM-ONE', 'Vessel','CHASEDB' "
    ...
    def __getitem__(self, index):
        ...
        if self.dataset == 'CHASEDB':
            img, mask = default_CHASEDB_loader(self.images[index], self.labels[index])
        else:
